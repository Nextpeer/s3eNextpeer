...
///
/// 	Used as the game title (welcome screen, tournament selector, etc)
///
...
////////////////////////////////////////////////////////////
///
/// NSNumber NPNotificationPosition. see Nextpeer.h
///
/// Default: NPNotificationPosition_TOP_LEFT on iPad,  NPNotificationPosition_TOP on iPhone.
///
/// Behavior: 	iPhone:
///				NPNotificationPosition_TOP:			iPhone notifications show up on the top of the screen
///				NPNotificationPosition_BOTTOM:		iPhone notifications show up on the bottom of the screen
///				
///				iPad:
